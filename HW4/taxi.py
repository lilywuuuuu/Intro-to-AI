...
class Agent():
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        else: max_next_Qopt = np.max(self.qtable[next_state])

        Qopt_old = self.qtable[state, action]
        ...
        self.qtable[state, action] = Qopt_new # update qtable to new Qopt
    ...
    def check_max_Q(self, state):
        ...
        return np.max(self.qtable[state]) # return the max Q value of given state
